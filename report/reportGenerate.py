...
class CodeAuditReport:
    ...
    def generate_report(self):
        ...
        if(risk_counts.any()):
            ...
            content += '''<center>
                              <img src="../images/risk_bar.png" style="zoom: 70%;" />
                          </center>\n\n'''
        else:
        ...
        if(invalid_func_counts.any()):
            ...
            content += '''<center>
                              <img src="../images/invalid_func_bar.png" style="zoom: 70%;" />
                          </center>\n\n'''
        else:
        ...
        if(invalid_val_counts.any()):
            ...
            content += '''<center>
                              <img src="../images/invalid_val_bar.png" style="zoom: 70%;" />
                          </center>\n\n'''
        else:
        ...
        if(risk_counts.any()):
            ...
            content += '''<center>
                              <img src="../images/risk_pie.png" style="zoom: 70%;" />
                          </center>\n\n'''
        else:
            content += "- 此程序代码中不存在风险函数\n\n"
        ...
        if(invalid_func_counts.any()):
            ...
            content += '''<center>
                              <img src="../images/invalid_func_pie.png" style="zoom: 70%;" />
                          </center>\n\n'''
        else:
            content += "- 此程序代码中不存在无效函数\n\n"
        ...
        try:
            ...
            self.open_pdf_with_default_app()
        except:
            QMessageBox.warning(None, "警告", "缺少wkhtmltopdf文件，请自行安装！")
